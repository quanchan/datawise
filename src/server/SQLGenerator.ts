import { AllowedGenOptions, Field, FieldConstraints, Format, GenOptions, TableConstraints, TableOptions, Tables, allowedGenOptions } from "@/types";
...
class SQLGenerator {
  public static async generateAllTables(tables: TableOptions[], kw: CreateTableKeywords): Promise<string> {
    let sql = "";
  ...
  public static async generateOneTable(table: TableOptions, kw: CreateTableKeywords): Promise<string> {
  ...
  public static generateType(genOptions: GenOptions, gen_opts_name: string = ""): string {
    ...
    return TypeProcessor.getDisplayType(genOptions.actualType, args as string[]);
  }
}
...
export class MySQLGenerator extends SQLGenerator {
  ...
  public static async generateAllTables(tables: TableOptions[]): Promise<string> {
